  ...
  const savePin = () => {
    if(title && about && destination && imageAsset?._id && category) {
      const doc = {
        ...
        image: {
          _type: 'image',
          asset: { // Stored as asset in sanity db ref and connectiing with doc
            _type: 'reference',
            _ref: imageAsset?._id
          }
        },
          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button
                  type="button"
                  className="absolute bottom-3 right-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out p-1 hover:p-3 hover:bg-red-600"
              ...
              >
                ...
                {categories.map((category) => (
                  <option
                    ...
                    value={category.name} key={category.image}
                  >
                    {category.name}
                  </option>
                ))}
